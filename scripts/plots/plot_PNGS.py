...
def plot_indel_hotspots(events_df, path_to_output_folder, tools_comb, reg_to_plot, env_specific):
    ...
    only_position_indel = only_position[only_position['PNGS'].isin(['inserted PNGS','deleted PNGS','conserved PNGS'])]
    ...
    for reg in reg_to_plot:
        ...
        g = sns.displot(data=only_position_indel[only_position_indel['region']==reg], x='position in ref', hue= 'PNGS', multiple='stack', 
                        ...
                        palette={'inserted PNGS':'#00539C', 'deleted PNGS':'#EEA47F', 'conserved PNGS':'#32a852'}) #, 'PNGS':'#32a852'
        ...
        g.savefig(os.path.join(path_to_output_folder, 'hotspot_'+reg+'_'+tools_comb+'.png'), dpi=400,transparent=True)
...
for MSA_tool in MSA_tools:
    for ASR_tool in ASR_tools:
        ...
        path_to_output_folder = '/cfs/earth/scratch/sepe/TM/results/results/plots/PNGS_vs_region'
